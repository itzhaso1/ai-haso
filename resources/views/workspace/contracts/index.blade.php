...
@section('content')
    ...
    <div class="space-y-4">
        <div class="flex flex-wrap items-end justify-between gap-3">
            <div>
                <h2 class="text-xl font-bold text-slate-900">العقود</h2>
                <p class="mt-1 text-xs text-slate-500">جزء من نظام الفوترة والحسابات لإدارة دورة العقود.</p>
            </div>
        ...
        <div class="grid gap-3 md:grid-cols-3">
            <article class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                <p class="text-xs text-slate-500">عقود مفتوحة (الصفحة الحالية)</p>
                        ...
                        <tr>
                            ...
                            <td class="px-3 py-3 text-left">
                                <div class="flex flex-wrap justify-end gap-2">
                                    <a href="{{ route($routePrefix.'.show', $contract) }}" class="rounded-md border border-slate-300 px-2 py-1 text-xs font-semibold text-slate-700 hover:bg-slate-100">عرض</a>
