                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-2">
                                        <details class="relative">
                                            <summary class="flex cursor-pointer list-none items-center gap-1 rounded-md border border-slate-300 px-2 py-1 text-xs font-semibold text-slate-700 hover:bg-slate-100">
                                                الإجراءات
                                                <span aria-hidden="true">▾</span>
                                            </summary>
                                            <div class="absolute right-0 z-20 mt-1 w-44 rounded-lg border border-slate-200 bg-white p-1 shadow-lg">
                                                <a href="{{ route('workspace.appointments.bookings.show', $booking) }}" class="block rounded-md px-2 py-1 text-xs text-slate-700 hover:bg-slate-100">تفاصيل</a>
                                                ...
                                                @if($canManageBookings)
                                                    ...
                                                    <form method="POST" action="{{ route('workspace.appointments.bookings.status', $booking) }}">
                                                        ...
                                                        <button class="block w-full rounded-md px-2 py-1 text-right text-xs text-slate-700 hover:bg-slate-100">In Progress</button>
                                                    </form>
                                                    <form method="POST" action="{{ route('workspace.appointments.bookings.status', $booking) }}">
                                                        @csrf
                                                    ...
                                                    <form method="POST" action="{{ route('workspace.appointments.bookings.status', $booking) }}">
                                                        ...
                                                        <button class="block w-full rounded-md px-2 py-1 text-right text-xs text-slate-700 hover:bg-slate-100">No-show</button>
                                                    </form>
                                                    <form method="POST" action="{{ route('workspace.appointments.bookings.status', $booking) }}">
                                                        @csrf
